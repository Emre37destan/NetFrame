...
title Microsoft Visual C++ Full Versiyonlar. Sahibi; Kral
echo.
echo Microsoft Visual C++ Full Versiyonlar. Sahibi; Kral
echo.
echo Versiyonlar Kuruluyor...
...
echo 2022...
start /wait vcredist2022_x86.exe /passive /norestart
...
echo 2022...
start /wait vcredist2022_x86.exe /passive /norestart
start /wait vcredist2022_x64.exe /passive /norestart
